...
public class Mail {
	public void mail() throws InterruptedException {
		...
		final String to = "vishal.giram@eqanim.com";
		final String cc = "seema.sandbhor@eqanim.com,nainesh.mahajan@eqanim.com,tushar@eqanim.com";
		final String subject = "Reg_Module2_Report";
